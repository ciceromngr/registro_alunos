...
type
  TForm1 = class(TForm)
    ...
    procedure btnRecuperaçãoClick(Sender: TObject);
...
procedure TForm1.btnRecuperaçãoClick(Sender: TObject);
begin
...
begin
  ...
  begin
   if alunos[I].Status.Equals(StatusAluno) then
     begin
      with mmoRegistroAlunos do
        begin
          ...
          Lines.Add('3a. nota.....: ' + Format('%.2f', [alunos[I].Media3]));
          Lines.Add('4a. nota.....: ' + Format('%.2f', [alunos[I].Media4]));
          Lines.Add('Média........: ' + Format('%.2f', [alunos[I].MediaAluno]));
          Lines.Add(Format('Status Aluno: %S',[alunos[I].Status]));
          Lines.Add('=========================================');
        end;
     end
    ...
    begin
      ShowMessage(Format('Não Existe Alunos: %S',[StatusAluno]));
      Abort;
    end;
  end;
end;
